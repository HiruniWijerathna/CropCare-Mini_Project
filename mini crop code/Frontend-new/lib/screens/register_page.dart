...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> _sendOtp(phone) async {
    ...
    String apiUrl =
        'https://app.notify.lk/api/v1/send?user_id=28166&api_key=oyVHXZJ4yRCmzBthd88j&sender_id=NotifyDEMO&to=+94${mobile.substring(1)}&message=Confirm your mobile phone number by entering this $otp';
